            ...
            <form method="post">
                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        ...
                        <button type="reset" class="btn btn-warning"><i class="fa-solid fa-trash-can-arrow-up"></i> Reset</button>
                        <a href="?page=peminjaman" class="btn btn-info"><i class="fa-solid fa-xmark"></i> Kembali</a>
                    </div>
                </div>
            </form>
        </div>  
