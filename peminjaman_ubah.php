            ...
            <form method="post">
                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        ...
                        <button type="reset" class="btn btn-secondary"><i class="fa-solid fa-trash-can-arrow-up"></i> Reset</button>
                        <a href="?page=peminjaman" class="btn btn-danger"><i class="fa-solid fa-xmark"></i> Kembali</a>
                    </div>
                </div>
            </form>
        </div>  
