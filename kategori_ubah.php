            ...
            <form method="post">
                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        ...
                        <a href="?page=kategori" class="btn btn-danger"><i class="fa-solid fa-trash-can-arrow-up"></i> Kembali</a>
                        <button type="reset" class="btn btn-secondary"><i class="fa-solid fa-xmark"></i> Reset</button>
                    </div>
                </div>
            </form>
        </div>  
