<h1 class="margin-bottom:50px;"> Buku</h1>
<div class="card">
    <div class="card-body">
        <div class="row">
        <div class="col-md-12">
            <form method="post">
                <?php
                    if(isset($_POST['submit'])) {
                        ...
                        $query =mysqli_query($koneksi, "INSERT INTO buku(id_buku,id_kategori,judul,penulis,penerbit,tahun_terbit,deskripsi) values ('', '$id_kategori','$judul','$penulis','$penerbit','$tahun_terbit','$deskripsi')");
                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        ...
                        <button type="reset" class="btn btn-dark"><i class="fa-solid fa-trash-can-arrow-up"></i> Reset</button>
                        <a href="?page=buku" class="btn btn-warning"><i class="fa-solid fa-xmark"></i> Kembali</a>
                    </div>
                </div>
            </form>
        </div>  
